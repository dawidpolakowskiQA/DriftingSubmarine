...
var AirPlaneCube = (function () {
    function AirPlaneCube(x, y, z) {
        ...
        var wheelTireMat = new THREE.MeshPhongMaterial({ color: Colors.BRWONDARK, shading: THREE.FlatShading });
    ...
    AirPlaneCube.prototype.update = function (currentMousePosition) {
        ...
        var targetY = this.normalize(currentMousePosition.y, -.75, .75, 25, 175);
        var targetX = this.normalize(currentMousePosition.x, -.75, .75, -100, 100);
...
var Sky = (function () {
    function Sky(numberOfClounds, x, y, z) {
        ...
        var stepAngle = Math.PI * 2 / this.numberOfClounds * 2;
        // create the clouds
...
var Game = (function () {
    ...
    Game.prototype.normalize = function (v, vmin, vmax, tmin, tmax) {
        var nv = Math.max(Math.min(v, vmax), vmin);
        var dv = vmax - vmin;
        var pc = (nv - vmin) / dv;
        var dt = tmax - tmin;
